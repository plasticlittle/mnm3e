...
import Actor3e from "./module/actor/entity.js";
import ActorSheet3eCharacter from "./module/actor/sheets/character.js";
...
import ItemSheet3eModifier from "./module/item/sheets/modifier.js";
import { MNM3E } from "./module/config.js";
import SummaryBuilder from "./module/apps/summary-builder.js";
import ScoreConfig from "./module/apps/score-config.js";
import PowerEffectTemplate from "./module/pixi/power-effect-template.js";
...
Hooks.once('init', async function () {
    ...
    CONFIG.MNM3E = MNM3E;
    CONFIG.Actor.documentClass = Actor3e;
    CONFIG.Item.documentClass = Item3e;
    CONFIG.Combat.initiative.formula = '1d20 + @attributes.initiative';
...
Hooks.once('setup', function () {
    ...
    toLocalize.forEach(o => {
        const localized = Object.entries(getProperty(CONFIG.MNM3E, o)).map(([name, identifier]) => [name, game.i18n.localize(identifier)]);
        setProperty(CONFIG.MNM3E, o, localized.reduce((obj, e) => {
            obj[e[0]] = e[1];
            return obj;
        }, {}));
    });
